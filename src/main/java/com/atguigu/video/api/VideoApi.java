...
public class VideoApi {
     ...
     */
        ...
        //账号AccessKey信息请填写(必选)
        private static String access_key_id = "LTAI4FdHHpxnDgBPksUyoWif";
        //账号AccessKey信息请填写(必选)
        private static String access_key_secret = "I5HkMVzmopT8M75aO91938A5CBlP2T";
//        //STS临时授权方式访问时该参数为必选，使用主账号AccessKey和RAM子账号AccessKey不需要填写
       private static String security_token = "";
        ...
        private final static Logger LOG = Logger.getLogger(VideoApi.class.getName());
        ...
        private static Map<String, String> generatePrivateParamters() {
            ...
            // 视频ID
            privateParams.put("VideoId","630bac64132f4e9f8fe5464853025fb3");
            // API名称
